...
export const LoginPage: React.FC = () => {
    ...
    const demoUsers = [
        { label: "Demo User 1", email: "demo@hintro.com", password: "demo1234" },
        { label: "Demo User 2", email: "demo2@hintro.com", password: "demo1234" },
        { label: "Demo User 3", email: "demo3@hintro.com", password: "demo1234" },
        { label: "Demo User 4", email: "demo4@hintro.com", password: "demo1234" },
    ];
        ...
        <div className="flex items-center justify-center min-h-screen p-4 md:p-8 relative overflow-x-hidden">
            ...
            <div className="w-full max-w-[440px] bg-black/50 backdrop-blur-xl border border-[#3a3a4a] rounded-3xl p-6 md:p-12">
                <div className="text-center mb-9">
                    ...
                    <p className="text-gray-400 text-md font-medium">Sign in to your workspace</p>
                </div>
                ...
                <form className="mb-7" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-6 flex flex-col">
                        <label htmlFor="password" className="text-sm font-semibold text-gray-300 mb-1.5 flex items-center gap-1.5 tracking-wide">
                            Password
                        </label>
                        <div className="flex items-center gap-3 bg-black/20 backdrop-blur-xl border border-gray-500 rounded-lg px-4 transition-all duration-30">
                ...
                <div className="text-center text-sm text-gray-400">
                    <p>Don't have an account? <Link to="/signup" className="text-indigo-300 no-underline transition-colors duration-300 hover:text-indigo-400">Sign up</Link></p>
                </div>

                <div className="mt-8 text-center p-4">
                    <p className="text-md text-white mb-3">Quick Demo Access</p>
                    <div className="flex flex-wrap justify-center gap-2">
                        {demoUsers.map((user) => (
                            <button
                                ...
                                className="px-3 py-1.5 text-xs font-medium rounded-lg text-indigo-300 border border-indigo-300 hover:text-white hover:bg-indigo-400/30 transition-all duration-300">
                                {user.label}
                            </button>
                        ))}
                    </div>
